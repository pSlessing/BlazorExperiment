...
{
    public static async Task<CsPlayer> GetTwistzzStats()
    {
        CsPlayer result;
        ...
        using (var page = await browser.NewPageAsync())
        {
            ...
            result = new CsPlayer(currentPlayerName, currentPlayerTag, currentImgSource,
...
class CsPlayer
{
    ...
    public CsPlayer(string playerName, string playerTag, string imgSource, string rating, string killsPerRound, string headshotPercentage, string mapsPlayed, string deathsPerRound, string roundsContributed) 
    {
